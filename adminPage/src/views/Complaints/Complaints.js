      ...
      <GridItem xs={12}>
        <Card>
          <CardHeader color="rose" icon>
            ...
            <h4 className={classes.cardIconTitle}>Tickets</h4>
          </CardHeader>
          <CardBody>
            <Dialog
              classes={{
            ...
            >
                  ...
                  <GridContainer>
                    <GridItem xs={12} md={4}>
                      <TextField
                        ...
                        style={{ width: "100%" }}
                        rowsMax={4}
                        value={list[modalID].sender.username}
                        variant="outlined"
                        disabled
                      />
                      <br />
                    ...
                    <GridItem lg={12} xs={12}>
                      ...
                      <br />
                      <br />
                      {list[modalID]?.status ? "Replied" : "To be replied"}
                    </GridItem>
                  </GridContainer>
                </DialogContent>
              ) : (
              ...
              >
                {!list[modalID]?.status ? (
                  <Button onClick={postRepliedText} color="info" round>
                    O K
                  </Button>
                ) : (
                  ""
                ...
                <Button onClick={() => setModal(false)} color="default" round>
                  Close
                </Button>
              </DialogActions>
            </Dialog>
            ...
            />
            <Table
              tableHead={["#", "Data", "Sender", "Replied", "Actions"]}
              tableData={list.map((ele, key) => [
                key + 1,
                ele.createdAt,
                ele.sender?.username,
                !ele.view_status && ele.status ? (
                  <Danger>
                    <VisibilityOff />
                  </Danger>
                ) : (
